...
describe('Validation', function () {
  describe('getValidatorChain', function () {
    ...
    after(function () {
      ...
      index.validation._ignoredValidationKeys.splice(
        index.validation._ignoredValidationKeys.indexOf(myIgnoredTextKey),
        1
      )
      index.validation._ignoredValidationKeys
        .indexOf(myIgnoredTextKey)
        .should.equal(-1)
    })
    ...
    it('ignore validator key', function () {
      index.validation._ignoredValidationKeys
        .indexOf(myIgnoredTextKey)
        .should.not.equal(-1)
      var validatorChainAsObject = index.validation.getValidatorChain(
        null,
        { myIgnoredTextKey: testFunction1 },
        null,
        null,
        null
      )
    ...
    it('single validator', function (done) {
      ...
      var validatorChainAsArray = index.validation.getValidatorChain(
        null,
        [{ myTestValidator: true, msg: testFunction1 }],
        null,
        null,
    ...
    it('multiple validators', function (done) {
      var validatorChainAsObject = index.validation.getValidatorChain(
        null,
        {
          myTestValidator: true,
          myTestValidator2: true,
          msg: myIgnoredTextKey,
        },
        null,
        null,
        null
      ...
      var validatorChainAsArray2 = index.validation.getValidatorChain(
        null,
        [
          { myTestValidator: true, msg: testFunction1 },
    ...
    it('validationChainStore by routeName', function (done) {
      var generationSpy = sinon.spy(
        index.validation,
        '_generateValidationChain'
      )
      ...
      var validatorChainAsObject2 = index.validation.getValidatorChain(
        null,
        { myTestValidator: true, msg: testFunction1 },
        null,
        null,
  ...
  describe('validate', function () {
    it('min', function (done) {
      var validationModel = {
          resources: { name: { isRequired: true, min: 10 } },
        },
        validationReq = { params: { name: 9 } },
        validationOptions = {}

      var errors = index.validation.process(
        validationModel,
        validationReq,
        validationOptions
      )
      ...
      var errors2 = index.validation.process(
        validationModel,
        validationReq,
        validationOptions
      )
    ...
    it('isIPv4', function (done) {
      var validationModel = {
          resources: { name: { isRequired: true, isIPv4: false } },
        },
        validationReq = { params: { name: 9 } },
        validationOptions = {}

      var errors0 = index.validation.process(
        validationModel,
        validationReq,
        validationOptions
      )
      ...
      var errors1 = index.validation.process(
        validationModel,
        validationReq,
        validationOptions
      )
    ...
    it('in body scope', function (done) {
      var validationModel = {
          content: { name: { isRequired: true, isIPv4: false } },
        },
      ...
      var validationModel = {
        resources: {
          brand: {
            ...
            regex: /^[0-9a-fA-F]{24}$/,
            description:
              'Return products from these brands. Can be declared multiple times.',
          },
        },
      }
    ...
    it('errorsAsArray / errorsAsObject', function (done) {
      ...
      var objectRes = index.validation.process(validationModel, validationReq, {
        errorsAsArray: false,
      })
      ...
      var arrayRes = index.validation.process(validationModel, validationReq, {
        errorsAsArray: true,
      })
    ...
    it('forbidUndefinedVariables', function (done) {
      ...
      var validRes = index.validation.process(validationModel, validationReq, {
        errorsAsArray: false,
        forbidUndefinedVariables: false,
      })
      validRes.should.be.empty

      var invalidRes = index.validation.process(
        validationModel,
        validationReq,
        { errorsAsArray: true, forbidUndefinedVariables: true }
      )
    ...
    it('function as validation parameter', function (done) {
      ...
      var validationRes = index.validation.process(
        validationModelTrue,
        validationReq,
        options
      )
    ...
    it('validation order', function (done) {
      ...
      var errors0 = index.validation.process(validationModel, validationReq, {
        errorsAsArray: true,
      })
    ...
    describe('isArray', function () {
      ...
      it('validate minLength', function () {
        ...
        var checkInvalidLength = index.validation.process(
          validationModel,
          validationReq,
          { errorsAsArray: true }
        )
        ...
        var checkTooShorts = index.validation.process(
          validationModel,
          validationReq,
          { errorsAsArray: true }
        )
      ...
      it('validate maxLength', function () {
        ...
        var checkInvalidValidLength = index.validation.process(
          validationModel,
          validationReq,
          { errorsAsArray: true }
        )
        ...
        var checkTooLong = index.validation.process(
          validationModel,
          validationReq,
          { errorsAsArray: true }
        )
    ...
    describe('isDictionary', function () {
      ...
      it('validate dictionary keys', function () {
        ...
        checkInvalidKeysInvalid[0].reason.should.equal(
    ...
    describe('isObject', function () {
      ...
      it('reject non-object when true', function () {
        var checkInvalidString = index.validation.process(
          { content: { strVal: { isObject: true } } },
          validationReq,
          { errorsAsArray: true }
        )
        ...
        var checkInvalidArray = index.validation.process(
          { content: { arrVal: { isObject: true } } },
          validationReq,
          { errorsAsArray: true }
        )
      ...
      it('validate properties', function () {
        ...
        var tests = [
          ...
          },
          {
            ...
            expected: {
              type: 'INVALID',
              field: 'person.preferences.favoriteNumber',
            },
          },
        ]
